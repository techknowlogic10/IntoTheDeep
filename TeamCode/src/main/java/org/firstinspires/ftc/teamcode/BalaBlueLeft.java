...
@Config
@Autonomous(name = "BalaBlueLeft")

public class BalaBlueLeft extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d initialPose = new Pose2d(38, 64, Math.toRadians(0));
        ...
        Actions.runBlocking(
                new SequentialAction(
                        drive.actionBuilder(drive.pose)
                                ...
                                //second sample
                                .strafeToLinearHeading(new Vector2d(secondSampleStrafeX, secondSampleStrafeY), Math.toRadians(270))
        ...
        moveToBasketAction = drive.actionBuilder(drive.pose)
                .waitSeconds(2)
                .strafeToLinearHeading(new Vector2d(basketX, basketY), Math.toRadians(45))
                .build();
        ...
        Actions.runBlocking(
                new SequentialAction(
                        drive.actionBuilder(drive.pose)
                                ...
                                //third sample)
                                .strafeToLinearHeading(new Vector2d(thirdSampleStrafeX, thirdSampleStrafeY), Math.toRadians(270))
                                .stopAndAdd(elevator.elevatorDown(elevatorDownPos))
                                .waitSeconds(0.5)
                                .stopAndAdd(elbow.downElbow())
                                .waitSeconds(1)
        ...
        Actions.runBlocking(
                new SequentialAction(
                        drive.actionBuilder(drive.pose)
                                ...
                                .waitSeconds(0.35)
                                //fourth sample
                                .strafeToLinearHeading(new Vector2d(fourthSampleStrafeX, fourthSampleStrafeY), Math.toRadians(270))
                                .stopAndAdd(elevator.elevatorDown(elevatorDownPos))
                                .waitSeconds(0.5)
                                .stopAndAdd(elbow.downElbow())
                                .waitSeconds(1)
