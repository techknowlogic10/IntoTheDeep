...
@Config
public final class MecanumDriveSpeed {
...
/*
       ...
       // public double trackWidthTicks = 5943.475305543868;
        ...
        public double kV = 0.0003913571544852509;
...
*/
      ...
      /*  //11/23/24
        ...
        // path profile parameters (in inches)
        public double maxWheelVel = 75;//100;//200;// 50;
        public double minProfileAccel = -45;//-60;//-120;//-30;
        public double maxProfileAccel = 75;//100;//200;//50;
        ...
        */
        //tuning on 12/3/24
        public double inPerTick = 0.01862313;
        public double lateralInPerTick = 0.021300011;
        public double trackWidthTicks = 1475.572134;

        // feedforward parameters (in tick units)
        public double kS = 1.507355103;
        public double kV = 0.004195996;
        public double kA = 0.001;

        // path profile parameters (in inches)
        public double maxWheelVel = 200;//75;//50;
        public double minProfileAccel = -120;//-45;//-30;
        public double maxProfileAccel = 200;//75;//50;
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer() {
            ...
            */
            ...
            leftFront = new OverflowEncoder(new RawEncoder(MecanumDriveSpeed.this.leftFront));
            leftBack = new OverflowEncoder(new RawEncoder(MecanumDriveSpeed.this.leftBack));
            rightBack = new OverflowEncoder(new RawEncoder(MecanumDriveSpeed.this.rightBack));
            rightFront = new OverflowEncoder(new RawEncoder(MecanumDriveSpeed.this.rightFront));
    ...
    public MecanumDriveSpeed(HardwareMap hardwareMap, Pose2d pose) {
        this.pose = pose;
        ...
        /*leftFront = hardwareMap.dcMotor.get("frontleft"); // Port #0
        rightFront = hardwareMap.dcMotor.get("frontright"); // Port #1
        leftBack = hardwareMap.dcMotor.get("backleft"); //Port#2
        rightBack = hardwareMap.dcMotor.get("backright"); //Port #3
