...
public class SimplifiedOdometryRobot {
    ...
    */
    ...
    //Tunning om 10/20/2024
    private final double ODOM_INCHES_PER_COUNT   = 0.0383509108341323; //0.002969;  //  GoBilda Odometry Pod (1/226.8)
