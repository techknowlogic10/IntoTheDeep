...
@Config
@Autonomous
public class YellowSampleBlueLeft extends LinearOpMode {
    ...
    public static double secondSampleForwardToBasket = 47;


    //third sample
    public static double thirdSampleBackwardY = 35;
    public static int thirdSampleRightTurnAngle = -117;
